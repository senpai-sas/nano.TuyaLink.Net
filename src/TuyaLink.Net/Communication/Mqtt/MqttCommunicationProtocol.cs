...
using TuyaLink.Communication.Mqtt.Topics;
...
namespace TuyaLink.Communication.Mqtt
{
    public class MqttCommunicationProtocol : ICommunicationHandler
    {
        ...
        private void InternalConnect()
        {
            ...
            MqttReasonCode reason = _mqttClient.Connect(
                _tuyaMqttSign.ClientId,
                _tuyaMqttSign.Username,
                _tuyaMqttSign.Password,
                true,
                ...
                null,
                true,
                (ushort)_deviceSettings.Communication.KeepAliveTime.TotalSeconds
                );
